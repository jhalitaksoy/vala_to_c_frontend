...
var app = (function () {
    ...
    // (79:2) <CodePanel className="vala-code-panel" title="Vala Code" bind:editor={valaeditor} options={optionsvala}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(79:2) <CodePanel className=\\\"vala-code-panel\\\" title=\\\"Vala Code\\\" bind:editor={valaeditor} options={optionsvala}>",
    		ctx
    	});
    ...
    // (96:2) <CodePanel className="vala-code-panel" title="Vala Code" bind:editor={valaeditor} options={optionsvala}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(icon.$$.fragment);
    			attr_dev(button, "class", "circular primary center");
    			add_location(button, file$1, 97, 4, 2469);
    			attr_dev(div, "class", "floating");
    			attr_dev(div, "style", "right:10px;top: 50px; z-index : 3;");
    			add_location(div, file$1, 96, 3, 2399);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(96:2) <CodePanel className=\\\"vala-code-panel\\\" title=\\\"Vala Code\\\" bind:editor={valaeditor} options={optionsvala}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(103:2) {#if showOutputPanel}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, optionsoutput, outputeditor, showOutputPanel, optionsc, ceditor, valaeditor*/ 1048639) {
	...
	stdout.printf ("Hello world!");
    	...
    	async function onConvertClick() {
    		...
    		if (response.ok) {
    			...
    			output = "";
    			c_code = _c_code;
    			$$invalidate(4, optionsc = getOptionsc());
    			$$invalidate(5, optionsoutput = getOptionsOutput());
    		} else {
